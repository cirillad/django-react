...
const EditCategoryPage: React.FC = () => {
    ...
    const { data: category, isLoading, error } = useGetCategoryQuery(id ? Number(id) : 0, {
        skip: !id, // якщо id немає, то пропускаємо запит
    });
    ...
    const onFinish = async (values: IFormValues) => {
        if (!id) {
            message.error("Невідомий ID категорії");
            return;
        }
        ...
        try {
            ...
            // Змінив formData на data, бо так зазвичай в apiCategory очікують
